    ...
    try {
      ...
      if (type.split(":")[1] === "add") {
        ...
        var embed2 = new MessageEmbed()
          ...
          .setFooter(`เพลงนี้ถูกขอโดยคุณ: ${res.tracks[0].requester.tag}`, res.tracks[0].requester.displayAvatarURL({
            dynamic: true
          }))
      ...
      player.pause(false);
          ...
          var embed = new MessageEmbed()
            ...
            .addField("🔂 Queue length: ", `\`${player.queue.length} Songs\``, true)
            .setFooter(`เพลงนี้ถูกขอโดยคุณ: ${track.requester.tag}`, track.requester.displayAvatarURL({
              dynamic: true
            }))
